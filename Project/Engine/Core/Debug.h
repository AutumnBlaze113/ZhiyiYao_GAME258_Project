...
{
public:
	enum class MessageType : unsigned short {//The order matters
		TYPE_NONE = 0,
		TYPE_FATAL_ERROR,
		TYPE_ERROR,
		TYPE_WARNING, 
	...
	static void OnCreate(const std::string& name_ = "GAME258EngineLog");// fill not requred, there is a default
